...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post();
	...
	<div id="main-content"<?php echo $main_content_style; ?>>	
		...
		<div class="container">
			<?php
					$p_gal = do_shortcode( '[team_carousel visible_items="6" total_items="-1" orderby="date" order="DESC" auto_rotate="no"]' );
					$spacer = '<div class="shortcode-wrapper shortcode-spacer clearfix"><div class="spacer" style="height:30px;"></div></div>';
					$sec_title = '<div class="shortcode-wrapper shortcode-title clearfix"><h3 class="hb-heading hb-center-heading alignleft"><span>The Taboo Girls</span></h3></div>
				';

					$full_gal = do_shortcode( '[fullwidth_section background_type="image" text_color="light" padding_top="20" padding_bottom="0" bg_color="#6a3a75" margin_top="-20" class="overflow-hidden" margin_bottom="-60" border="" parallax="" scissors_icon="" overlay="" image="3940" waved_border_top="" waved_border_bottom=""]' . $spacer.$sec_title.$p_gal. $spacer . $spacer . '[/fullwidth_section]' );

			?>

			<div class="vc_row element-row row gs-no-mgn">
